...
console.log(firstName + " " + lastName + " (" + age + ") " + "werkt als " + occupation + " en is " + maritalStatus + " met " + numberOfChildren + " kind(eren). Ze draagt vaak " + eyeColor + "e kleding en ziet eruit als " + shoeSize + " jaar.")